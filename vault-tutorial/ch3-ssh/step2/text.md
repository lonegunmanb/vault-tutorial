...
下面这张图把整个过程类比成"访客拿总部签发的访客证进公司大门"，结合
后面 6 个小节一起看更直观——前台只认总部公章，桌上的访客名册根本
没启用：

![SSH user certificate flow, visitor pass analogy](../assets/client-cert-visitor-pass.png)
